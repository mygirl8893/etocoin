...
// Copyright (c) 2018, The ElienCoin Developers
// 
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1752159;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(720000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "ETOCoin";
